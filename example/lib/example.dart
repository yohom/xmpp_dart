...
void main(List<String> arguments) {
  ...
  var userAtDomain = 'user003@xmpp.tuobaye.cn';
  ...
  connection.connect();
  xmpp.MessagesListener messagesListener = ExampleMessagesListener(connection);
  ...
  var receiver = 'user002@xmpp.tuobaye.cn';
...
class ExampleConnectionStateChangedListener
  ...
  void onConnectionStateChanged(xmpp.XmppConnectionState state) {
    if (state == xmpp.XmppConnectionState.Ready) {
      ...
      var receiver = 'user002@openfire.tuobaye.cn';
      var receiverJid = xmpp.Jid.fromFullJid(receiver);
...
class ExampleMessagesListener implements xmpp.MessagesListener {
  ...
  ExampleMessagesListener(this.connection);
  ...
  void onNewMessage(xmpp.MessageStanza message) {
    if (message.body != null) {
      ...
      var messageHandler = xmpp.MessageHandler.getInstance(connection);
      messageHandler.sendMessage(message.fromJid, "收到咯哦~~");
    }
  }
}
